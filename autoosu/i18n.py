...
STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "mode.section": {"zh": "游戏模式", "en": "Game mode"},
    "mode.standard": {"zh": "osu!standard（默认）", "en": "osu!standard (default)"},
    "mode.mania4k": {"zh": "osu!mania 4K（规则生成）", "en": "osu!mania 4K (rules)"},
    ...
    "models.mania_rules": {"zh": "mania 4K 使用独立规则生成器；standard 模型不会被加载",
                            "en": "mania 4K uses a dedicated rules generator; standard models are not loaded"},
    ...
    "result.diff.mania": {"zh": "  {name} 4K：{objects} 个物件（{holds} 长按），{nps:.1f} 个/秒",
                          "en": "  {name} 4K: {objects} objects ({holds} holds), {nps:.1f}/s"},
